...
class MasonryRendimiento extends StatefulWidget {
  ...
  @override
  _MasonryRendimientoState createState() =>
      _MasonryRendimientoState();
}

class _MasonryRendimientoState
    extends State<MasonryRendimiento> {
  ...
  Widget _buildIconItem(
      ...
      DocumentSnapshot rendimientoFisico,
