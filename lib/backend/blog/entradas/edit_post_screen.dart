...
import '../../../functions/posts/update_post_functions.dart';
...
class EditPostScreenState extends State<EditPostScreen> {
  ...
  void _initializeFields() {
    _loadCategoryNames().then((_) {
      _nameControllerEsp.text = widget.postData['NombreEsp'] ?? '';
      _nameControllerEng.text = widget.postData['NombreEng'] ?? '';
      _descriptionControllerEsp.text = widget.postData['DescripcionEsp'] ?? '';
      _descriptionControllerEng.text = widget.postData['DescripcionEng'] ?? '';
      _imageUrl = widget.postData['URL de la Imagen'] ?? '';
      _loadSelectedCategories();
    });
  }

  void _loadSelectedCategories() {
    List<dynamic> categoriesData = widget.postData['Categorias'] ?? [];
    _selectedCategories = categoriesData.map((categoryData) {
      String categoryId = categoryData['id'].toString();
      String categoryEsp =
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: Text(AppLocalizations.of(context)!.translate('EditPost')),
          bottom: TabBar(
            tabs: tabs,
            labelStyle:
  ...
  Widget _buildPostForm(String langKey) {
    ...
    GlobalKey<RichEditorState> editorKey =
        langKey == 'Esp' ? _richEditorStateEsp : _richEditorStateEng;
    ...
    return _buildCustomButton(
      ...
      () async {
        ...
        if (_nameControllerEsp.text.isNotEmpty &&
          ...
          await UpdatePostFunctions().updatePost(
            id: widget.postId,
  ...
  void _showSuccessSnackbar(BuildContext context) {
    Fluttertoast.showToast(
      msg: AppLocalizations.of(context)!.translate('postUpdated'),
