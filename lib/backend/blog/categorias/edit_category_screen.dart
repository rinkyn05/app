...
import '../../../functions/category/edit_category_functions.dart';
...
class EditCategoryScreenState extends State<EditCategoryScreen> {
  ...
  void initState() {
    super.initState();
    _nameControllerEsp =
        TextEditingController(text: widget.category['NombreEsp']);
    _descriptionControllerEsp =
        TextEditingController(text: widget.category['DescripcionEsp']);
    _nameControllerEng =
        TextEditingController(text: widget.category['NombreEng']);
    _descriptionControllerEng =
        TextEditingController(text: widget.category['DescripcionEng']);
    _imageUrl = widget.category['URL de la Imagen'];
    _checkAccess();
  }
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: Text(AppLocalizations.of(context)!.translate('editCategory')),
          bottom: TabBar(
            tabs: tabs,
  ...
  Widget _buildCategoryForm(TextEditingController nameController,
            ...
            children: [
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                  labelText:
                      '${AppLocalizations.of(context)!.translate('categoryName')} ($langKey)',
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                  labelText:
                      '${AppLocalizations.of(context)!.translate('categoryDescription')} ($langKey)',
                  hintText: AppLocalizations.of(context)!
                      .translate('enterCategoryDescription'),
                  border: borderStyle,
                  enabledBorder: borderStyle,
                  focusedBorder: borderStyle.copyWith(
                    borderSide: const BorderSide(
    ...
    return _buildCustomButton(
      ...
      () async {
        if (_nameControllerEsp.text.isNotEmpty &&
          ...
          await UpdateCategoryFunctions().updateCategory(
            id: categoryId,
  ...
  void _showSuccessSnackbar(BuildContext context) {
    Fluttertoast.showToast(
      msg: AppLocalizations.of(context)!.translate('categoryUpdated'),
