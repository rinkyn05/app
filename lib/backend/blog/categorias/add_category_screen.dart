...
import '../../../functions/category/add_category_functions.dart';
...
class AddCategoryScreenState extends State<AddCategoryScreen> {
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: Text(AppLocalizations.of(context)!.translate('addCategory')),
          bottom: TabBar(
            tabs: const [
              Tab(text: 'Español'),
              Tab(text: 'English'),
        ...
        body: TabBarView(
          children: [
            ...
            _buildCategoryForm(
                _nameControllerEng, _descriptionControllerEng, 'Inglés'),
          ],
        ),
      ),
    );
  ...
  void _showSuccessSnackbar(BuildContext context) {
    Fluttertoast.showToast(
      msg: AppLocalizations.of(context)!.translate('categoryAdded'),
    ...
    return _buildCustomButton(
      ...
      () async {
        if (_nameControllerEsp.text.isNotEmpty &&
          ...
          await AddCategoryFunctions().addCategoryWithAutoIncrementId(
            nombreEsp: _nameControllerEsp.text,
            descripcionEsp: _descriptionControllerEsp.text,
            nombreEng: _nameControllerEng.text,
            descripcionEng: _descriptionControllerEng.text,
