...
import '../../../functions/contents/equipment/edit_equipment_functions.dart';
...
class EditEquipmentScreen extends StatefulWidget {
  ...
  const EditEquipmentScreen({Key? key, required this.equipment})
      : super(key: key);

  @override
  EditEquipmentScreenState createState() => EditEquipmentScreenState();
}

class EditEquipmentScreenState extends State<EditEquipmentScreen> {
  ...
  void initState() {
    super.initState();
    _nameControllerEsp =
        TextEditingController(text: widget.equipment['NombreEsp']);
    _descriptionControllerEsp =
        TextEditingController(text: widget.equipment['DescripcionEsp']);
    _nameControllerEng =
        TextEditingController(text: widget.equipment['NombreEng']);
    _descriptionControllerEng =
        TextEditingController(text: widget.equipment['DescripcionEng']);
    _imageUrl = widget.equipment['URL de la Imagen'];
    _checkAccess();
  }
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: Text(AppLocalizations.of(context)!.translate('editEquipment')),
          bottom: TabBar(
            tabs: tabs,
  ...
  Widget _buildEquipmentForm(TextEditingController nameController,
          ...
          child: Column(
            ...
            children: [
              Padding(
                ...
                child: Text(
                  AppLocalizations.of(context)!.translate('equipmentName'),
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                  labelText:
                      '${AppLocalizations.of(context)!.translate('equipmentName')} ($langKey)',
                  hintText: AppLocalizations.of(context)!
                      .translate('enterEquipmentName'),
                  border: borderStyle,
              ...
              Padding(
                ...
                child: Text(
                  AppLocalizations.of(context)!
                      .translate('equipmentDescription'),
                  style: Theme.of(context).textTheme.titleMedium,
                ),
              ),
              TextFormField(
                ...
                decoration: InputDecoration(
                  labelText:
                      '${AppLocalizations.of(context)!.translate('equipmentDescription')} ($langKey)',
                  hintText: AppLocalizations.of(context)!
                      .translate('enterEquipmentDescription'),
                  border: borderStyle,
                  enabledBorder: borderStyle,
                  focusedBorder: borderStyle.copyWith(
                    borderSide: const BorderSide(
    ...
    return _buildCustomButton(
      ...
      () async {
        if (_nameControllerEsp.text.isNotEmpty &&
            ...
            _imageUrl != null) {
          String equipmentId = widget.equipment['id'].toString();
          await UpdateEquipmentFunctions().updateEquipment(
            id: equipmentId,
  ...
  void _showSuccessSnackbar(BuildContext context) {
    Fluttertoast.showToast(
      msg: AppLocalizations.of(context)!.translate('equipmentUpdated'),
