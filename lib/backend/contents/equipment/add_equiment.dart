...
import '../../../functions/contents/equipment/add_equipment_functions.dart';
...
class AddEquipmentScreen extends StatefulWidget {
  ...
  @override
  AddEquipmentScreenState createState() => AddEquipmentScreenState();
}

class AddEquipmentScreenState extends State<AddEquipmentScreen> {
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: Text(AppLocalizations.of(context)!.translate('addEquipment')),
          bottom: TabBar(
            tabs: tabs,
    ...
    return _buildCustomButton(
      ...
      () async {
        if (_nameControllerEsp.text.isNotEmpty &&
          ...
          await AddEquipmentFunctions().addEquipmentWithAutoIncrementId(
            nombreEsp: _nameControllerEsp.text,
            descripcionEsp: _descriptionControllerEsp.text,
            nombreEng: _nameControllerEng.text,
            descripcionEng: _descriptionControllerEng.text,
  ...
  void _showSuccessSnackbar(BuildContext context) {
    Fluttertoast.showToast(
      msg: AppLocalizations.of(context)!.translate('equipmentAdded'),
