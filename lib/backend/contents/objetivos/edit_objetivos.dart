...
import '../../../functions/contents/objetivo/edit_objetivos_functions.dart';
import '../../../config/utils/appcolors.dart';
import '../../../functions/upload_exercise_image.dart';

class EditObjetivosScreen extends StatefulWidget {
  final Map<String, dynamic> objetivos;

  const EditObjetivosScreen({Key? key, required this.objetivos})
      : super(key: key);

  @override
  EditObjetivosScreenState createState() => EditObjetivosScreenState();
}

class EditObjetivosScreenState extends State<EditObjetivosScreen> {
  ...
  void initState() {
    super.initState();
    _nameControllerEsp =
        TextEditingController(text: widget.objetivos['NombreEsp']);
    _descriptionControllerEsp =
        TextEditingController(text: widget.objetivos['DescripcionEsp']);
    _nameControllerEng =
        TextEditingController(text: widget.objetivos['NombreEng']);
    _descriptionControllerEng =
        TextEditingController(text: widget.objetivos['DescripcionEng']);
    _imageUrl = widget.objetivos['URL de la Imagen'];
  }
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: Text(AppLocalizations.of(context)!.translate('editApplicableTo')),
          bottom: TabBar(
            tabs: tabs,
  ...
  Widget _buildObjetivosForm(TextEditingController nameController,
          ...
          child: Column(
            ...
            children: [
              Padding(
                ...
                child: Text(
                  AppLocalizations.of(context)!.translate('editApplicableTo'),
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                  labelText:
                      '${AppLocalizations.of(context)!.translate('editApplicableTo')} ($langKey)',
    ...
    return _buildCustomButton(
      ...
      () async {
        if (_nameControllerEsp.text.isNotEmpty &&
            ...
            _imageUrl != null) {
          String objetivosId = widget.objetivos['id'].toString();
          await UpdateObjetivosFunctions().updateObjetivos(
            id: objetivosId,
  ...
  void _showSuccessSnackbar(BuildContext context) {
    Fluttertoast.showToast(
      msg: AppLocalizations.of(context)!.translate('ApplicableToUpdated'),
