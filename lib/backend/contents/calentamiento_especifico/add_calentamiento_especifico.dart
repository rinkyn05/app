...
import '../../../functions/contents/calentamiento_especifico/add_calentamiento_epecifico_functions.dart';
import '../../../functions/upload_exercise_image.dart';

class AddCalentamientoEspecificoScreen extends StatefulWidget {
  const AddCalentamientoEspecificoScreen({super.key});

  @override
  AddCalentamientoEspecificoScreenState createState() =>
      AddCalentamientoEspecificoScreenState();
}

class AddCalentamientoEspecificoScreenState
    extends State<AddCalentamientoEspecificoScreen> {
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: Text(AppLocalizations.of(context)!
              .translate('addCalentamientoEspecifico')),
          bottom: TabBar(
            tabs: tabs,
    ...
    return _buildCustomButton(
      ...
      () async {
        if (_nameControllerEsp.text.isNotEmpty &&
          ...
          var newCalentamientoEspecifico = {
          ...
          await AddCalentamientoEspecificoFunctions()
              .addCalentamientoEspecificoWithAutoIncrementId(
            nombreEsp: _nameControllerEsp.text,
            descripcionEsp: _descriptionControllerEsp.text,
            nombreEng: _nameControllerEng.text,
            descripcionEng: _descriptionControllerEng.text,
          ...
          Provider.of<CalentamientoEspecificoNotifier>(context, listen: false)
              .addCalentamientoEspecifico(newCalentamientoEspecifico);
  ...
  void _showSuccessSnackbar(BuildContext context) {
    Fluttertoast.showToast(
      msg: AppLocalizations.of(context)!
          .translate('calentamientoEspecificoAdded'),
