...
import '../../../functions/contents/calentamiento_especifico/edit_calentamiento_especifico_functions.dart';
import '../../../functions/role_checker.dart';
import '../../../functions/upload_exercise_image.dart';

class EditCalentamientoEspecificoScreen extends StatefulWidget {
  final Map<String, dynamic> calentamientoEspecifico;

  const EditCalentamientoEspecificoScreen({Key? key, required this.calentamientoEspecifico})
      : super(key: key);

  @override
  EditCalentamientoEspecificoScreenState createState() => EditCalentamientoEspecificoScreenState();
}

class EditCalentamientoEspecificoScreenState extends State<EditCalentamientoEspecificoScreen> {
  ...
  void initState() {
    super.initState();
    _nameControllerEsp =
        TextEditingController(text: widget.calentamientoEspecifico['NombreEsp']);
    _descriptionControllerEsp =
        TextEditingController(text: widget.calentamientoEspecifico['DescripcionEsp']);
    _nameControllerEng =
        TextEditingController(text: widget.calentamientoEspecifico['NombreEng']);
    _descriptionControllerEng =
        TextEditingController(text: widget.calentamientoEspecifico['DescripcionEng']);
    _imageUrl = widget.calentamientoEspecifico['URL de la Imagen'];
    _checkAccess();
  }
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: Text(AppLocalizations.of(context)!.translate('editCalentamientoEspecifico')),
          bottom: TabBar(
            tabs: tabs,
        ...
        body: TabBarView(
          children: [
            _buildCalentamientoEspecificoForm(
  ...
  Widget _buildCalentamientoEspecificoForm(TextEditingController nameController,
            ...
            children: [
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                  labelText:
                      '${AppLocalizations.of(context)!.translate('calentamientoEspecifico')} ($langKey)',
                  hintText: AppLocalizations.of(context)!
                      .translate('enterCalentamientoEspecifico'),
                  border: borderStyle,
              ...
              Padding(
                ...
                child: Text(
                  AppLocalizations.of(context)!
                      .translate('calentamientoEspecificoDescription'),
                  style: Theme.of(context).textTheme.titleMedium,
                ),
              ),
              TextFormField(
                ...
                decoration: InputDecoration(
                  labelText:
                      '${AppLocalizations.of(context)!.translate('calentamientoEspecificoDescription')} ($langKey)',
                  hintText: AppLocalizations.of(context)!
                      .translate('enterCalentamientoEspecificoDescription'),
                  border: borderStyle,
                  enabledBorder: borderStyle,
                  focusedBorder: borderStyle.copyWith(
                    borderSide: const BorderSide(
    ...
    return _buildCustomButton(
      ...
      () async {
        if (_nameControllerEsp.text.isNotEmpty &&
            ...
            _imageUrl != null) {
          String calentamientoEspecificoId = widget.calentamientoEspecifico['id'].toString();
          await UpdateCalentamientoEspecificoFunctions().updateCalentamientoEspecifico(
  ...
  void _showSuccessSnackbar(BuildContext context) {
    Fluttertoast.showToast(
      msg: AppLocalizations.of(context)!.translate('calentamientoEspecificoUpdated'),
