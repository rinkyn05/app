...
import '../../../functions/contents/bodypart/edit_body_part_functions.dart';
import '../../../config/utils/appcolors.dart';
import '../../../functions/role_checker.dart';
import '../../../functions/upload_exercise_image.dart';

class EditBodyPartScreen extends StatefulWidget {
  final Map<String, dynamic> bodyPart;

  const EditBodyPartScreen({Key? key, required this.bodyPart})
      : super(key: key);

  @override
  EditBodyPartScreenState createState() => EditBodyPartScreenState();
}

class EditBodyPartScreenState extends State<EditBodyPartScreen> {
  ...
  void initState() {
    super.initState();
    _nameControllerEsp =
        TextEditingController(text: widget.bodyPart['NombreEsp']);
    _descriptionControllerEsp =
        TextEditingController(text: widget.bodyPart['DescripcionEsp']);
    _nameControllerEng =
        TextEditingController(text: widget.bodyPart['NombreEng']);
    _descriptionControllerEng =
        TextEditingController(text: widget.bodyPart['DescripcionEng']);
    _imageUrl = widget.bodyPart['URL de la Imagen'];
    _checkAccess();
  }
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: Text(AppLocalizations.of(context)!.translate('editMusculoObjetivo')),
          bottom: TabBar(
            tabs: tabs,
            ...
            children: [
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                  labelText:
                      '${AppLocalizations.of(context)!.translate('MusculoObjetivo')} ($langKey)',
                  hintText: AppLocalizations.of(context)!
                      .translate('enterMusculoObjetivo'),
                  border: borderStyle,
              ...
              Padding(
                ...
                child: Text(
                  AppLocalizations.of(context)!
                      .translate('MusculoObjetivoDescription'),
                  style: Theme.of(context).textTheme.titleMedium,
                ),
              ),
              TextFormField(
                ...
                decoration: InputDecoration(
                  labelText:
                      '${AppLocalizations.of(context)!.translate('MusculoObjetivoDescription')} ($langKey)',
                  hintText: AppLocalizations.of(context)!
                      .translate('enterMusculoObjetivoDescription'),
                  border: borderStyle,
                  enabledBorder: borderStyle,
                  focusedBorder: borderStyle.copyWith(
                    borderSide: const BorderSide(
    ...
    return _buildCustomButton(
      ...
      () async {
        if (_nameControllerEsp.text.isNotEmpty &&
            ...
            _imageUrl != null) {
          String bodyPartId = widget.bodyPart['id'].toString();
          await UpdateBodyPartFunctions().updateBodyPart(
            id: bodyPartId,
  ...
  void _showSuccessSnackbar(BuildContext context) {
    Fluttertoast.showToast(
      msg: AppLocalizations.of(context)!.translate('bodyPartUpdated'),
