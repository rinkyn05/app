...
import '../../../functions/contents/bodypart/add_body_part_functions.dart';
import '../../../functions/upload_exercise_image.dart';

class AddBodyPartScreen extends StatefulWidget {
  const AddBodyPartScreen({super.key});

  @override
  AddBodyPartScreenState createState() => AddBodyPartScreenState();
}

class AddBodyPartScreenState extends State<AddBodyPartScreen> {
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: Text(AppLocalizations.of(context)!.translate('addMusculoObjetivo')),
          bottom: TabBar(
            tabs: tabs,
    ...
    return _buildCustomButton(
      ...
      () async {
        if (_nameControllerEsp.text.isNotEmpty &&
          ...
          await AddBodyPartFunctions().addBodyPartWithAutoIncrementId(
            nombreEsp: _nameControllerEsp.text,
            descripcionEsp: _descriptionControllerEsp.text,
            nombreEng: _nameControllerEng.text,
            descripcionEng: _descriptionControllerEng.text,
  ...
  void _showSuccessSnackbar(BuildContext context) {
    Fluttertoast.showToast(
      msg: AppLocalizations.of(context)!.translate('MusculoObjetivoAdded'),
