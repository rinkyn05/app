...
import '../../../functions/contents/estiramiento_especifico/add_estiramiento_epecifico_functions.dart';
import '../../../functions/upload_exercise_image.dart';

class AddEstiramientoEspecificoScreen extends StatefulWidget {
  const AddEstiramientoEspecificoScreen({super.key});

  @override
  AddEstiramientoEspecificoScreenState createState() =>
      AddEstiramientoEspecificoScreenState();
}

class AddEstiramientoEspecificoScreenState
    extends State<AddEstiramientoEspecificoScreen> {
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: Text(AppLocalizations.of(context)!
              .translate('addEstiramientoEspecifico')),
          bottom: TabBar(
            tabs: tabs,
    ...
    return _buildCustomButton(
      ...
      () async {
        if (_nameControllerEsp.text.isNotEmpty &&
          ...
          await AddEstiramientoEspecificoFunctions()
              .addEstiramientoEspecificoWithAutoIncrementId(
            nombreEsp: _nameControllerEsp.text,
            descripcionEsp: _descriptionControllerEsp.text,
            nombreEng: _nameControllerEng.text,
            descripcionEng: _descriptionControllerEng.text,
          ...
          Provider.of<EstiramientoEspecificoNotifier>(context, listen: false)
              .addEstiramientoEspecifico(newEstiramientoEspecifico);
  ...
  void _showSuccessSnackbar(BuildContext context) {
    Fluttertoast.showToast(
      msg: AppLocalizations.of(context)!
          .translate('estiramientoEspecificoAdded'),
