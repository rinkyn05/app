...
import '../../../functions/contents/estiramiento_especifico/edit_estiramiento_especifico_functions.dart';
import '../../../functions/role_checker.dart';
import '../../../functions/upload_exercise_image.dart';

class EditEstiramientoEspecificoScreen extends StatefulWidget {
  final Map<String, dynamic> estiramientoEspecifico;

  const EditEstiramientoEspecificoScreen({Key? key, required this.estiramientoEspecifico})
      : super(key: key);

  @override
  EditEstiramientoEspecificoScreenState createState() => EditEstiramientoEspecificoScreenState();
}

class EditEstiramientoEspecificoScreenState extends State<EditEstiramientoEspecificoScreen> {
  ...
  void initState() {
    super.initState();
    _nameControllerEsp =
        TextEditingController(text: widget.estiramientoEspecifico['NombreEsp']);
    _descriptionControllerEsp =
        TextEditingController(text: widget.estiramientoEspecifico['DescripcionEsp']);
    _nameControllerEng =
        TextEditingController(text: widget.estiramientoEspecifico['NombreEng']);
    _descriptionControllerEng =
        TextEditingController(text: widget.estiramientoEspecifico['DescripcionEng']);
    _imageUrl = widget.estiramientoEspecifico['URL de la Imagen'];
    _checkAccess();
  }
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: Text(AppLocalizations.of(context)!.translate('editEstiramientoEspecifico')),
          bottom: TabBar(
            tabs: tabs,
        ...
        body: TabBarView(
          children: [
            _buildEstiramientoEspecificoForm(
  ...
  Widget _buildEstiramientoEspecificoForm(TextEditingController nameController,
            ...
            children: [
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                  labelText:
                      '${AppLocalizations.of(context)!.translate('estiramientoEspecifico')} ($langKey)',
                  hintText: AppLocalizations.of(context)!
                      .translate('enterEstiramientoEspecifico'),
                  border: borderStyle,
              ...
              Padding(
                ...
                child: Text(
                  AppLocalizations.of(context)!
                      .translate('estiramientoEspecificoDescription'),
                  style: Theme.of(context).textTheme.titleMedium,
                ),
              ),
              TextFormField(
                ...
                decoration: InputDecoration(
                  labelText:
                      '${AppLocalizations.of(context)!.translate('estiramientoEspecificoDescription')} ($langKey)',
                  hintText: AppLocalizations.of(context)!
                      .translate('enterEstiramientoEspecificoDescription'),
                  border: borderStyle,
                  enabledBorder: borderStyle,
                  focusedBorder: borderStyle.copyWith(
                    borderSide: const BorderSide(
    ...
    return _buildCustomButton(
      ...
      () async {
        if (_nameControllerEsp.text.isNotEmpty &&
            ...
            _imageUrl != null) {
          String estiramientoEspecificoId = widget.estiramientoEspecifico['id'].toString();
          await UpdateEstiramientoEspecificoFunctions().updateEstiramientoEspecifico(
  ...
  void _showSuccessSnackbar(BuildContext context) {
    Fluttertoast.showToast(
      msg: AppLocalizations.of(context)!.translate('estiramientoEspecificoUpdated'),
