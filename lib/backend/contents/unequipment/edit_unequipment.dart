...
import '../../../functions/contents/unequipment/edit_unequipment_functions.dart';
import '../../../config/utils/appcolors.dart';
import '../../../functions/role_checker.dart';
import '../../../functions/upload_exercise_image.dart';

class EditUnequipmentScreen extends StatefulWidget {
  final Map<String, dynamic> unequipment;

  const EditUnequipmentScreen({Key? key, required this.unequipment})
      : super(key: key);

  @override
  EditUnequipmentScreenState createState() => EditUnequipmentScreenState();
}

class EditUnequipmentScreenState extends State<EditUnequipmentScreen> {
  ...
  void initState() {
    super.initState();
    _nameControllerEsp =
        TextEditingController(text: widget.unequipment['NombreEsp']);
    _descriptionControllerEsp =
        TextEditingController(text: widget.unequipment['DescripcionEsp']);
    _nameControllerEng =
        TextEditingController(text: widget.unequipment['NombreEng']);
    _descriptionControllerEng =
        TextEditingController(text: widget.unequipment['DescripcionEng']);
    _imageUrl = widget.unequipment['URL de la Imagen'];
    _checkAccess();
  }
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title:
              Text(AppLocalizations.of(context)!.translate('editUnequipment')),
          bottom: TabBar(
            tabs: tabs,
  ...
  Widget _buildUnequipmentForm(TextEditingController nameController,
          ...
          child: Column(
            ...
            children: [
              Padding(
                ...
                child: Text(
                  AppLocalizations.of(context)!.translate('unequipmentName'),
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                  labelText:
                      '${AppLocalizations.of(context)!.translate('unequipmentName')} ($langKey)',
                  hintText: AppLocalizations.of(context)!
                      .translate('enterUnequipmentName'),
                  border: borderStyle,
              ...
              Padding(
                ...
                child: Text(
                  AppLocalizations.of(context)!
                      .translate('unequipmentDescription'),
                  style: Theme.of(context).textTheme.titleMedium,
                ),
              ),
              TextFormField(
                ...
                decoration: InputDecoration(
                  labelText:
                      '${AppLocalizations.of(context)!.translate('unequipmentDescription')} ($langKey)',
                  hintText: AppLocalizations.of(context)!
                      .translate('enterUnequipmentDescription'),
                  border: borderStyle,
                  enabledBorder: borderStyle,
                  focusedBorder: borderStyle.copyWith(
                    borderSide: const BorderSide(
    ...
    return _buildCustomButton(
      ...
      () async {
        if (_nameControllerEsp.text.isNotEmpty &&
            ...
            _imageUrl != null) {
          String unequipmentId = widget.unequipment['id'].toString();
          await UpdateUnequipmentFunctions().updateUnequipment(
            id: unequipmentId,
  ...
  void _showSuccessSnackbar(BuildContext context) {
    Fluttertoast.showToast(
      msg: AppLocalizations.of(context)!.translate('unequipmentUpdated'),
