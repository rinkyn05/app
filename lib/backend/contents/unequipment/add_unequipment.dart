...
import '../../../functions/contents/unequipment/add_unequipment_functions.dart';
import '../../../functions/upload_exercise_image.dart';

class AddUnequipmentScreen extends StatefulWidget {
  const AddUnequipmentScreen({super.key});

  @override
  AddUnequipmentScreenState createState() => AddUnequipmentScreenState();
}

class AddUnequipmentScreenState extends State<AddUnequipmentScreen> {
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title:
              Text(AppLocalizations.of(context)!.translate('addUnequipment')),
          bottom: TabBar(
            tabs: tabs,
    ...
    return _buildCustomButton(
      ...
      () async {
        if (_nameControllerEsp.text.isNotEmpty &&
          ...
          await AddUnequipmentFunctions().addUnequipmentWithAutoIncrementId(
            nombreEsp: _nameControllerEsp.text,
            descripcionEsp: _descriptionControllerEsp.text,
            nombreEng: _nameControllerEng.text,
            descripcionEng: _descriptionControllerEng.text,
          ...
          Provider.of<UnequipmentNotifier>(context, listen: false)
              .addUnequipment(newUnequipment);
  ...
  void _showSuccessSnackbar(BuildContext context) {
    Fluttertoast.showToast(
      msg: AppLocalizations.of(context)!.translate('unequipmentAdded'),
