...
import '../../functions/calentamiento_fisico/update_calentamiento_fisico_functions.dart';

import '../../functions/role_checker.dart';
import '../../functions/upload_exercise_image.dart';

class EditCalentamientoFisicoScreen extends StatefulWidget {
  final String calentamientoFisicoId;
  final Map<String, dynamic> calentamientoFisicoData;

  const EditCalentamientoFisicoScreen(
      {Key? key, required this.calentamientoFisicoId, required this.calentamientoFisicoData})
      : super(key: key);

  @override
  EditCalentamientoFisicoScreenState createState() => EditCalentamientoFisicoScreenState();
}

class EditCalentamientoFisicoScreenState extends State<EditCalentamientoFisicoScreen> {
  ...
  Future<void> _initializeFields() async {
    _nameControllerEsp.text = widget.calentamientoFisicoData['NombreEsp'] ?? '';
    _nameControllerEng.text = widget.calentamientoFisicoData['NombreEng'] ?? '';
    _contenidoControllerEsp.text = widget.calentamientoFisicoData['ContenidoEsp'] ?? '';
    _contenidoControllerEng.text = widget.calentamientoFisicoData['ContenidoEng'] ?? '';
    _imageUrl = widget.calentamientoFisicoData['URL de la Imagen'] ?? '';
    _videoController.text = widget.calentamientoFisicoData['Video'] ?? '';
    _membershipEsp = widget.calentamientoFisicoData['MembershipEsp'] ?? 'Gratis';
    _membershipEng = widget.calentamientoFisicoData['MembershipEng'] ?? 'Free';
  }
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: Text(AppLocalizations.of(context)!.translate('EditCalentamientoFisico')),
          bottom: TabBar(
            tabs: tabs,
            labelStyle:
        ...
        body: TabBarView(
          children: [
            _buildCalentamientoFisicoForm('Esp'),
            _buildCalentamientoFisicoForm('Eng'),
          ],
        ),
      ),
    );
  ...
  Widget _buildCalentamientoFisicoForm(String langKey) {
          ...
          children: [
            ...
            TextFormField(
              ...
              decoration: InputDecoration(
                labelText:
                    '${AppLocalizations.of(context)!.translate('calentamientoFisico')} ($langKey)',
                hintText:
                    AppLocalizations.of(context)!.translate('enterCalentamientoFisicoName'),
                border: borderStyle,
    ...
    return _buildCustomButton(
      ...
      () async {
        ...
        if (_nameControllerEsp.text.isNotEmpty &&
          ...
          await UpdateCalentamientoFisicoFunctions().updateCalentamientoFisico(
            id: widget.calentamientoFisicoId,
  ...
  void _showSuccessSnackbar(BuildContext context) {
    Fluttertoast.showToast(
      msg: AppLocalizations.of(context)!.translate('calentamientoFisicoUpdated'),
