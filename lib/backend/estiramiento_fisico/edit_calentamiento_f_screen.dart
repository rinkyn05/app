...
import '../../functions/estiramiento_fisico/update_estiramiento_fisico_functions.dart';
import '../../functions/role_checker.dart';
import '../../functions/upload_exercise_image.dart';

class EditEstiramientoFisicoScreen extends StatefulWidget {
  final String estiramientoFisicoId;
  final Map<String, dynamic> estiramientoFisicoData;

  const EditEstiramientoFisicoScreen(
      {Key? key, required this.estiramientoFisicoId, required this.estiramientoFisicoData})
      : super(key: key);

  @override
  EditEstiramientoFisicoScreenState createState() => EditEstiramientoFisicoScreenState();
}

class EditEstiramientoFisicoScreenState extends State<EditEstiramientoFisicoScreen> {
  ...
  Future<void> _initializeFields() async {
    _nameControllerEsp.text = widget.estiramientoFisicoData['NombreEsp'] ?? '';
    _nameControllerEng.text = widget.estiramientoFisicoData['NombreEng'] ?? '';
    _contenidoControllerEsp.text = widget.estiramientoFisicoData['ContenidoEsp'] ?? '';
    _contenidoControllerEng.text = widget.estiramientoFisicoData['ContenidoEng'] ?? '';
    _imageUrl = widget.estiramientoFisicoData['URL de la Imagen'] ?? '';
    _videoController.text = widget.estiramientoFisicoData['Video'] ?? '';
    _membershipEsp = widget.estiramientoFisicoData['MembershipEsp'] ?? 'Gratis';
    _membershipEng = widget.estiramientoFisicoData['MembershipEng'] ?? 'Free';
  }
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: Text(AppLocalizations.of(context)!.translate('EditEstiramientoFisico')),
          bottom: TabBar(
            tabs: tabs,
            labelStyle:
        ...
        body: TabBarView(
          children: [
            _buildEstiramientoFisicoForm('Esp'),
            _buildEstiramientoFisicoForm('Eng'),
          ],
        ),
      ),
    );
  ...
  Widget _buildEstiramientoFisicoForm(String langKey) {
          ...
          children: [
            ...
            TextFormField(
              ...
              decoration: InputDecoration(
                labelText:
                    '${AppLocalizations.of(context)!.translate('estiramientoFisico')} ($langKey)',
                hintText:
                    AppLocalizations.of(context)!.translate('enterEstiramientoFisicoName'),
                border: borderStyle,
    ...
    return _buildCustomButton(
      ...
      () async {
        ...
        if (_nameControllerEsp.text.isNotEmpty &&
          ...
          await UpdateEstiramientoFisicoFunctions().updateEstiramientoFisico(
            id: widget.estiramientoFisicoId,
  ...
  void _showSuccessSnackbar(BuildContext context) {
    Fluttertoast.showToast(
      msg: AppLocalizations.of(context)!.translate('estiramientoFisicoUpdated'),
