...
import '../../functions/ejercicios/estiramiento_especifico_in_ejercicio_functions.dart';
...
import '../../functions/estiramiento_fisico/add_estiramiento_fisico_functions.dart';
...
import '../models/estiramiento_especifico_in_ejercicio_model.dart';
import '../models/objetivos_in_ejercicio_model.dart';
import '../models/sports_in_ejercicio_model.dart';

class AddEstiramientoFisicoScreen extends StatefulWidget {
  const AddEstiramientoFisicoScreen({Key? key}) : super(key: key);

  @override
  AddEstiramientoFisicoScreenState createState() =>
      AddEstiramientoFisicoScreenState();
}

class AddEstiramientoFisicoScreenState
    extends State<AddEstiramientoFisicoScreen> {
  ...
  final List<SelectedEstiramientoEspecifico> _selectedEstiramientoEspecifico =
      [];
  ...
  void _addEstiramientoEspecifico(String estiramientoEspecificoId) {
    if (!_selectedEstiramientoEspecifico
        .any((selected) => selected.id == estiramientoEspecificoId)) {
      String estiramientoEspecificoEsp =
          EstiramientoEspecificoNames[estiramientoEspecificoId]?['Esp'] ??
              'Nombre no disponible';
      String estiramientoEspecificoEng =
          EstiramientoEspecificoNames[estiramientoEspecificoId]?['Eng'] ??
              'Nombre no disponible';
      setState(() {
        _selectedEstiramientoEspecifico.add(SelectedEstiramientoEspecifico(
          id: estiramientoEspecificoId,
  ...
  void _removeEstiramientoEspecifico(String EstiramientoEspecificoId) {
    setState(() {
      _selectedEstiramientoEspecifico.removeWhere((EstiramientoEspecifico) =>
          EstiramientoEspecifico.id == EstiramientoEspecificoId);
    });
  }
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: Text(AppLocalizations.of(context)!
              .translate('addEstiramientoFisico')),
          bottom: TabBar(
            tabs: tabs,
        ...
        body: TabBarView(
          children: [
            _buildEstiramientoFisicotsForm(
                _nameControllerEsp,
  ...
  Widget _buildEstiramientoFisicotsForm(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 10),
            _buildSelectedEstiramientoEspecifico(langKey),
            FutureBuilder<List<DropdownMenuItem<String>>>(
              future: EstiramientoEspecificoInEjercicioFunctions()
                  .getSimplifiedEstiramientoEspecifico(langKey),
              builder: (context, snapshot) {
                if (!snapshot.hasData) {
                  return const CircularProgressIndicator();
                }
                      ...
                      DropdownButtonHideUnderline(
                        child: DropdownButton<String>(
                          ...
                          hint: Text(AppLocalizations.of(context)!
                              .translate('selectEstiramientoEspecifico')),
                          onChanged: (String? newValue) {
                            _addEstiramientoEspecifico(newValue!);
                          },
                          items: snapshot.data,
                          value: snapshot.data!.isNotEmpty
                              ? snapshot.data?.first.value
    ...
    return _buildCustomButton(
      ...
      () async {
        if (_nameControllerEsp.text.isNotEmpty &&
          ...
          await AddEstiramientoFisicoFunctions()
              .addEstiramientoFisicoWithAutoIncrementId(
            ...
            SelectedEstiramientoEspecifico: _selectedEstiramientoEspecifico,
  ...
  void _showSuccessSnackbar(BuildContext context) {
    Fluttertoast.showToast(
      msg: AppLocalizations.of(context)!.translate('estiramientoFisicoAdded'),
  ...
  void _clearFields() {
    ...
    setState(() {
      ...
      _selectedEstiramientoEspecifico.clear();
