...
import 'entrenamiento_mixto_plan_creator.dart';

class EntrenamientoMixtoAdaptVideo extends StatefulWidget {
  @override
  _EntrenamientoMixtoAdaptVideoState createState() => _EntrenamientoMixtoAdaptVideoState();
}

class _EntrenamientoMixtoAdaptVideoState extends State<EntrenamientoMixtoAdaptVideo> {
  String selectedCard = '';
  ...
  void _navigateToExerciseScreen(String title) {
    switch (title) {
      case 'Crear Plan':
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => EntrenamientoMixtoPlanCreator()),
        );
        break;
      case 'Deltoide':
        Navigator.push(
