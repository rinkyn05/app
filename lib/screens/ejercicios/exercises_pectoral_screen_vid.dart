...
class ExercisesPectoralScreenVid extends StatefulWidget {
  const ExercisesPectoralScreenVid({Key? key}) : super(key: key);

  @override
  State<ExercisesPectoralScreenVid> createState() =>
      _ExercisesPectoralScreenVidState();
}

class _ExercisesPectoralScreenVidState
    extends State<ExercisesPectoralScreenVid> {
  ...
  Future<List<Ejercicio>> _fetchExercises() async {
    ...
    List<Ejercicio> filteredExercises = allExercises.where((ejercicio) {
      for (var bodypart in ejercicio.bodyParts) {
        if (bodypart['NombreEng'] == 'Pectoral' &&
            bodypart['NombreEsp'] == 'Pectoral') {
          return true;
        }
      }
      return false;
  ...
  Future<void> _selectExercise(Ejercicio ejercicio) async {
    ...
    await prefs.setString('selected_body_part_pectoral', 'Pectoral');
    await prefs.setString('selected_exercise_name_pectoral', ejercicio.nombre);
