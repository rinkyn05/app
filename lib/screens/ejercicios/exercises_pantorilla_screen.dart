...
// Constructor opcional
  ...
  @override
  State<ExercisesPantorrillasScreen> createState() =>
      _ExercisesPantorrillasScreenState();
}

class _ExercisesPantorrillasScreenState
    extends State<ExercisesPantorrillasScreen> {
  ...
  Future<List<Ejercicio>> _fetchExercises() async {
    ...
    List<Ejercicio> filteredExercises = allExercises.where((ejercicio) {
      for (var bodypart in ejercicio.bodyParts) {
        if (bodypart['NombreEng'] == 'Pantorrillas' &&
            bodypart['NombreEsp'] == 'Pantorrillas') {
          return true;
        }
      }
      return false;
  ...
  Future<void> _selectExercise(Ejercicio ejercicio) async {
    ...
    _exerciseNotifier.selectExercise('Pantorrillas');
