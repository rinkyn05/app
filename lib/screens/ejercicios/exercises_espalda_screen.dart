...
class _ExercisesEspaldaScreenState extends State<ExercisesEspaldaScreen> {
  ...
  Future<void> _selectExercise(Ejercicio ejercicio) async {
    ...
    await prefs.setString('selected_body_part_espalda', 'Espalda');
    await prefs.setString('selected_exercise_name_espalda', ejercicio.nombre);
    await prefs.setString(
        'selected_exercise_details_espalda', ejercicio.toJson());
