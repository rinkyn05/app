...
class ExercisesTibialAScreenVid extends StatefulWidget {
  const ExercisesTibialAScreenVid({Key? key}) : super(key: key);
...
class _ExercisesTibialAScreenVidState extends State<ExercisesTibialAScreenVid> {
  ...
  Future<void> _selectExercise(Ejercicio ejercicio) async {
    ...
    await prefs.setString('selected_body_part_tibial_anterior', 'Tibial anterior');
    await prefs.setString('selected_exercise_name_tibial_anterior', ejercicio.nombre);
    await prefs.setString('selected_exercise_details_tibial_anterior', ejercicio.toJson());
