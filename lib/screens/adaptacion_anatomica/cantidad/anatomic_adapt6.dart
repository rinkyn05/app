...
class AnatomicAdaptVideo6 extends StatefulWidget {
  @override
  _AnatomicAdaptVideo6State createState() => _AnatomicAdaptVideo6State();
}

class _AnatomicAdaptVideo6State extends State<AnatomicAdaptVideo6> {
  String selectedCard = '';
...
// Función para enviar los datos a Firestore
  ...
  List<CardWidget> _getFilteredCards(SelectionNotifier notifier) {
    // Asumir que la cantidad de ejercicios es 6
    int cantidadDeEjerciciosEsp = 6;

    print("Valor de cantidadDeEjerciciosEsp: $cantidadDeEjerciciosEsp");

    // Definir los títulos de las tarjetas para el caso 6
    List<String> cardTitles = [
      'Crear Plan',
      'Deltoide',
      'Espalda',
