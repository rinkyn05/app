...
class AnatomicAdaptVideo4 extends StatefulWidget {
  @override
  _AnatomicAdaptVideo4State createState() => _AnatomicAdaptVideo4State();
}

class _AnatomicAdaptVideo4State extends State<AnatomicAdaptVideo4> {
  String selectedCard = '';
...
// Función para enviar los datos a Firestore
  ...
  List<CardWidget> _getFilteredCards(SelectionNotifier notifier) {
    // Asumir que la cantidad de ejercicios es 4
    int cantidadDeEjerciciosEsp = 4;

    print("Valor de cantidadDeEjerciciosEsp: $cantidadDeEjerciciosEsp");

    // Definir los títulos de las tarjetas para el caso 4
    List<String> cardTitles = [
      'Crear Plan',
      'Deltoide',
      'Espalda o Pectoral',
