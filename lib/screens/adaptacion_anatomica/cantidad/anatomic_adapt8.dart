...
class AnatomicAdaptVideo8 extends StatefulWidget {
  @override
  _AnatomicAdaptVideo8State createState() => _AnatomicAdaptVideo8State();
}

class _AnatomicAdaptVideo8State extends State<AnatomicAdaptVideo8> {
  String selectedCard = '';
...
// Función para enviar los datos a Firestore
  ...
  List<CardWidget> _getFilteredCards(SelectionNotifier notifier) {
    // Asumir que la cantidad de ejercicios es 8
    int cantidadDeEjerciciosEsp = 8;

    print("Valor de cantidadDeEjerciciosEsp: $cantidadDeEjerciciosEsp");

    // Definir los títulos de las tarjetas para el caso 8
    List<String> cardTitles = [
      'Crear Plan',
      'Deltoide',
      'Espalda',
