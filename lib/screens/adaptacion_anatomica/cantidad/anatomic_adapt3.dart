...
class AnatomicAdaptVideo3 extends StatefulWidget {
  @override
  _AnatomicAdaptVideo3State createState() => _AnatomicAdaptVideo3State();
}

class _AnatomicAdaptVideo3State extends State<AnatomicAdaptVideo3> {
  String selectedCard = '';
...
// Función para enviar los datos a Firestore
  ...
  // Asumir que la cantidad de ejercicios es 3
  int cantidadDeEjerciciosEsp = 3;

  print("Valor de cantidadDeEjerciciosEsp: $cantidadDeEjerciciosEsp");

  // Definir los títulos de las tarjetas para el caso 3
  List<String> cardTitles = [
    'Crear Plan',
    'Espalda o Pectoral',
    'Abdomen',
