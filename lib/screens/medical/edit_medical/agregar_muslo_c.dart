...
class AgregarMusloC extends StatefulWidget {
  final String email;
  ...
  @override
  _AgregarMusloCState createState() => _AgregarMusloCState();
}

class _AgregarMusloCState extends State<AgregarMusloC> {
  int currentStep = 6;
      ...
      try {
        ...
        if (user != null) {
          await _firestore.collection('usersmedical').doc(widget.email).update({
            'Circunferencias.Muslo Contraido': _musloContraido,
          });
