...
class AgregarMuneca extends StatefulWidget {
  final String email;
  ...
  @override
  _AgregarMunecaState createState() => _AgregarMunecaState();
}

class _AgregarMunecaState extends State<AgregarMuneca> {
  int currentStep = 5;
      ...
      try {
        ...
        if (user != null) {
          await _firestore.collection('usersmedical').doc(widget.email).update({
            'Circunferencias.Muñeca': _muneca,
          });
