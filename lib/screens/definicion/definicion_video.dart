...
import 'definicion_plan_creator.dart';

class DefinicionAdaptVideo extends StatefulWidget {
  @override
  _DefinicionAdaptVideoState createState() => _DefinicionAdaptVideoState();
}

class _DefinicionAdaptVideoState extends State<DefinicionAdaptVideo> {
  String selectedCard = '';
  ...
  void _navigateToExerciseScreen(String title) {
    switch (title) {
      case 'Crear Plan':
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => DefinicionPlanCreator()),
        );
        break;
      case 'Deltoide':
        Navigator.push(
