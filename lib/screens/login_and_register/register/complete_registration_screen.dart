...
class CompleteRegistrationScreenState
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(AppLocalizations.of(context)!.translate('completeInfo')),
      ),
          ...
          child: Column(
            children: [
              ...
              Row(
                ...
                children: [
                  if (currentStep > 2) SizedBox(width: 20),
                    ...
                    Expanded(
                      ...
                      child: TextFormField(
                        ...
                        validator: (value) {
                          if (value == null || value.isEmpty) {
                            return AppLocalizations.of(context)!
                                .translate('enterYourWingspan');
                          }
                          if (double.tryParse(value) == null) {
                            return AppLocalizations.of(context)!
                                .translate('enterValidWingspan');
                          }
                          return null;
                        },
                        onChanged: (value) {
                    ...
                    Expanded(
                      ...
                      child: TextFormField(
                        ...
                        validator: (value) {
                          if (value == null || value.isEmpty) {
                            return AppLocalizations.of(context)!
                                .translate('enterYourSeatedHeight');
                          }
                          if (double.tryParse(value) == null) {
                            return AppLocalizations.of(context)!
                                .translate('enterValidSeatedHeight');
                          }
                          return null;
                        },
                        onChanged: (value) {
