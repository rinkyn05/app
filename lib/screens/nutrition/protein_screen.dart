...
import '../alimentos/proteina_animal_screen.dart';
import '../alimentos/proteina_vegetal_screen.dart';
                ...
                _buildCategoryCard(
                  ...
                  () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => ProteinaAnimalScreen(),
                      ),
                    );
                  },
                ),
                _buildCategoryCard(
                  ...
                  () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => ProteinaVegetalScreen(),
                      ),
                    );
                  },
                ),
