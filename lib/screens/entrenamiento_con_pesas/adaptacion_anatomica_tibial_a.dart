...
import 'adaptacion_anatomica_abdomen.dart';
...
class AdaptacionAnatomicaTibialA extends StatefulWidget {
  final List<Ejercicio> ejerciciosSeleccionados;

  AdaptacionAnatomicaTibialA({required this.ejerciciosSeleccionados});

  @override
  _AdaptacionAnatomicaTibialAState createState() =>
      _AdaptacionAnatomicaTibialAState();
}

class _AdaptacionAnatomicaTibialAState extends State<AdaptacionAnatomicaTibialA> {
  String selectedCard = 'Tibial Anterior';
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      setState(() {
        languageCode = Provider.of<LanguageNotifier>(context, listen: false)
            ...
            .languageCode;
        _ejerciciosFuture =
            FrontEndFirestoreServices().getEjerciciosTibialA(languageCode);
        _fetchEjercicios();
      });
    });
  }
  ...
  void _fetchEjercicios() {
    _ejerciciosFuture = FrontEndFirestoreServices().getEjerciciosTibialA(languageCode);
  }
  ...
  Widget _buildCard(BuildContext context, String title) {
    Color cardColor = title == 'Tibial Anterior' ? const Color.fromARGB(255, 150, 208, 255) : Colors.white;
        ...
        setState(() {
          ...
          switch (selectedCard) {
            case 'Todos':
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => AdaptacionAnatomicaScreen(ejerciciosSeleccionados: ejerciciosSeleccionados,)),
              );
              break;
            case 'Deltoide':
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => AdaptacionAnatomicaDeltoid(ejerciciosSeleccionados: ejerciciosSeleccionados,)),
              );
              break;
            case 'Pectoral':
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => AdaptacionAnatomicaPectoral(ejerciciosSeleccionados: ejerciciosSeleccionados,)),
              );
              break;
            case 'Bíceps':
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => AdaptacionAnatomicaBiceps(ejerciciosSeleccionados: ejerciciosSeleccionados,)),
              );
              break;
            case 'Abdomen':
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => AdaptacionAnatomicaAbdomen(ejerciciosSeleccionados: ejerciciosSeleccionados,)),
              );
              break;
            case 'Antebrazo':
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => AdaptacionAnatomicaAntebrazo(ejerciciosSeleccionados: ejerciciosSeleccionados,)),
              );
              break;
            case 'Cuádriceps':
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => AdaptacionAnatomicaCuadriceps(ejerciciosSeleccionados: ejerciciosSeleccionados,)),
              );
              break;
            case 'Tibial Anterior':
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => AdaptacionAnatomicaTibialA(ejerciciosSeleccionados: ejerciciosSeleccionados,)),
              );
              break;
            default:
              break;
