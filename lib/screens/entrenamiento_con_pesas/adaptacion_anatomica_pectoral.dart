...
class AdaptacionAnatomicaPectoral extends StatefulWidget {
  final List<Ejercicio> ejerciciosSeleccionados;

  AdaptacionAnatomicaPectoral({required this.ejerciciosSeleccionados});
  
  @override
  _AdaptacionAnatomicaPectoralState createState() =>
      _AdaptacionAnatomicaPectoralState();
}

class _AdaptacionAnatomicaPectoralState extends State<AdaptacionAnatomicaPectoral> {
  String selectedCard = 'Pectoral';
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      setState(() {
        languageCode = Provider.of<LanguageNotifier>(context, listen: false)
            ...
            .languageCode;
        _ejerciciosFuture =
            FrontEndFirestoreServices().getEjerciciosPectoral(languageCode);
        _fetchEjercicios();
      });
    });
  }
  ...
  void _fetchEjercicios() {
    _ejerciciosFuture = FrontEndFirestoreServices().getEjerciciosPectoral(languageCode);
  }
  ...
  Widget _buildCard(BuildContext context, String title) {
    Color cardColor = title == 'Pectoral' ? const Color.fromARGB(255, 150, 208, 255) : Colors.white;
