...
class AdaptacionAnatomicaBiceps extends StatefulWidget {
  final List<Ejercicio> ejerciciosSeleccionados;

  AdaptacionAnatomicaBiceps({required this.ejerciciosSeleccionados});

  @override
  _AdaptacionAnatomicaBicepsState createState() =>
      _AdaptacionAnatomicaBicepsState();
}

class _AdaptacionAnatomicaBicepsState extends State<AdaptacionAnatomicaBiceps> {
  String selectedCard = 'Bíceps';
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      setState(() {
        languageCode = Provider.of<LanguageNotifier>(context, listen: false)
            ...
            .languageCode;
        _ejerciciosFuture =
            FrontEndFirestoreServices().getEjerciciosBiceps(languageCode);
        _fetchEjercicios();
      });
    });
  }
  ...
  void _fetchEjercicios() {
    _ejerciciosFuture = FrontEndFirestoreServices().getEjerciciosBiceps(languageCode);
  }
  ...
  Widget _buildCard(BuildContext context, String title) {
    Color cardColor = title == 'Bíceps' ? const Color.fromARGB(255, 150, 208, 255) : Colors.white;
