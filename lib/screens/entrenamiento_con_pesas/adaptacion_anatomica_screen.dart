...
class AdaptacionAnatomicaScreen extends StatefulWidget {
  ...
  AdaptacionAnatomicaScreen({required this.ejerciciosSeleccionados});
      ...
      switch (selectedCard) {
        ...
        case 'Abdomen':
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => AdaptacionAnatomicaAbdomen(
                ejerciciosSeleccionados: ejerciciosSeleccionados,
              ),
            ),
          );
        ...
        case 'Antebrazo':
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => AdaptacionAnatomicaAntebrazo(
                ejerciciosSeleccionados: ejerciciosSeleccionados,
              ),
            ),
          );
        ...
        case 'Cuádriceps':
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => AdaptacionAnatomicaCuadriceps(
                ejerciciosSeleccionados: ejerciciosSeleccionados,
              ),
            ),
          );
        ...
        case 'Tibial Anterior':
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => AdaptacionAnatomicaTibialA(
                ejerciciosSeleccionados: ejerciciosSeleccionados,
              ),
            ),
          );
