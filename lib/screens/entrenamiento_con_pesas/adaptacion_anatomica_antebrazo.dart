...
class AdaptacionAnatomicaAntebrazo extends StatefulWidget {
  final List<Ejercicio> ejerciciosSeleccionados;

  AdaptacionAnatomicaAntebrazo({required this.ejerciciosSeleccionados});

  @override
  _AdaptacionAnatomicaAntebrazoState createState() =>
      _AdaptacionAnatomicaAntebrazoState();
}

class _AdaptacionAnatomicaAntebrazoState extends State<AdaptacionAnatomicaAntebrazo> {
  String selectedCard = 'Antebrazo';
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      setState(() {
        languageCode = Provider.of<LanguageNotifier>(context, listen: false)
            ...
            .languageCode;
        _ejerciciosFuture =
            FrontEndFirestoreServices().getEjerciciosAntebrazo(languageCode);
        _fetchEjercicios();
      });
    });
  }
  ...
  void _fetchEjercicios() {
    _ejerciciosFuture = FrontEndFirestoreServices().getEjerciciosAntebrazo(languageCode);
  }
  ...
  Widget _buildCard(BuildContext context, String title) {
    Color cardColor = title == 'Antebrazo' ? const Color.fromARGB(255, 150, 208, 255) : Colors.white;
