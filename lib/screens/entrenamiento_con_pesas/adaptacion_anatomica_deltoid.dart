...
class AdaptacionAnatomicaDeltoid extends StatefulWidget {
  final List<Ejercicio> ejerciciosSeleccionados;

  AdaptacionAnatomicaDeltoid({required this.ejerciciosSeleccionados});

  @override
  _AdaptacionAnatomicaDeltoidState createState() =>
      _AdaptacionAnatomicaDeltoidState();
}

class _AdaptacionAnatomicaDeltoidState extends State<AdaptacionAnatomicaDeltoid> {
  String selectedCard = 'Deltoide';
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      setState(() {
        languageCode = Provider.of<LanguageNotifier>(context, listen: false)
            ...
            .languageCode;
        _ejerciciosFuture =
            FrontEndFirestoreServices().getEjerciciosDeltoid(languageCode);
        _fetchEjercicios();
      });
    });
  }
  ...
  void _fetchEjercicios() {
    _ejerciciosFuture = FrontEndFirestoreServices().getEjerciciosDeltoid(languageCode);
  }
  ...
  Widget _buildCard(BuildContext context, String title) {
    Color cardColor = title == 'Deltoide' ? const Color.fromARGB(255, 150, 208, 255) : Colors.white;
