...
class AdaptacionAnatomicaCuadriceps extends StatefulWidget {
  final List<Ejercicio> ejerciciosSeleccionados;

  AdaptacionAnatomicaCuadriceps({required this.ejerciciosSeleccionados});

  @override
  _AdaptacionAnatomicaCuadricepsState createState() =>
      _AdaptacionAnatomicaCuadricepsState();
}

class _AdaptacionAnatomicaCuadricepsState extends State<AdaptacionAnatomicaCuadriceps> {
  String selectedCard = 'Cuádriceps';
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      setState(() {
        languageCode = Provider.of<LanguageNotifier>(context, listen: false)
            ...
            .languageCode;
        _ejerciciosFuture =
            FrontEndFirestoreServices().getEjerciciosCuadriceps(languageCode);
        _fetchEjercicios();
      });
    });
  }
  ...
  void _fetchEjercicios() {
    _ejerciciosFuture = FrontEndFirestoreServices().getEjerciciosCuadriceps(languageCode);
  }
  ...
  Widget _buildCard(BuildContext context, String title) {
    Color cardColor = title == 'Cuádriceps' ? const Color.fromARGB(255, 150, 208, 255) : Colors.white;
