...
import '../../functions/alimentos/carb_simple_firestore.dart';
import '../../widgets/custom_appbar_new.dart';
import 'carb_detalle_screen.dart';

class CarbSimpleScreen extends StatefulWidget {
  const CarbSimpleScreen({Key? key}) : super(key: key);

  @override
  CarbSimpleScreenState createState() => CarbSimpleScreenState();
}

class CarbSimpleScreenState extends State<CarbSimpleScreen> {
  ...
  void _fetchAlimentos() {
    _alimentosFuture = CarbSimpleFirestoreServices()
            ...
            children: [
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      "${AppLocalizations.of(context)!.translate('carbohydratesSimples')}",
