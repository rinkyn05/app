...
import '../../functions/alimentos/protein_animal_firestore.dart';
import '../../widgets/custom_appbar_new.dart';
import 'protein_detalle_screen.dart';

class ProteinaAnimalScreen extends StatefulWidget {
  const ProteinaAnimalScreen({Key? key}) : super(key: key);

  @override
  ProteinaAnimalScreenState createState() => ProteinaAnimalScreenState();
}

class ProteinaAnimalScreenState extends State<ProteinaAnimalScreen> {
  ...
  void _fetchAlimentos() {
    _alimentosFuture = ProteinAnimalFirestoreServices()
        .filterProteinaAnimalAnimal(languageCode)
            ...
            children: [
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      "${AppLocalizations.of(context)!.translate('proteinAnimal')}",
