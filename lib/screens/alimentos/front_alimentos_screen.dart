...
import '../../functions/alimentos/front_alimentos_firestore_services.dart';
import '../../widgets/custom_appbar_new.dart';
import 'alimentos_detalle_screen.dart';

class FrontAlimentosScreen extends StatefulWidget {
  const FrontAlimentosScreen({Key? key}) : super(key: key);

  @override
  FrontAlimentosScreenState createState() => FrontAlimentosScreenState();
}

class FrontAlimentosScreenState extends State<FrontAlimentosScreen> {
  ...
  void _fetchAlimentos() {
    _alimentosFuture = FrontAlimentosFirestoreServices()
        .getAlimentos(languageCode)
