...
import 'transicion_plan_creator.dart';

class TransicionAdaptVideo extends StatefulWidget {
  @override
  _TransicionAdaptVideoState createState() => _TransicionAdaptVideoState();
}

class _TransicionAdaptVideoState extends State<TransicionAdaptVideo> {
  String selectedCard = '';
  ...
  void _navigateToExerciseScreen(String title) {
    switch (title) {
      case 'Crear Plan':
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => transicionPlanCreator()),
        );
        break;
      case 'Deltoide':
        Navigator.push(
